...
static inline bool is_treasure(object t) { return t >= min_treasure; }
...
static inline bool toting(object t) { return place[t] < 0; }
...
const char *incantation[] = {"fee", "fie", "foe", "foo", "fum"};
int foobar;
...
static inline void destroy(object t) { move(t, limbo); }
...
bool pct(int r) { return ran(100) < r; }
